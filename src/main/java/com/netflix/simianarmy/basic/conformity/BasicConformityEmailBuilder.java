...
public class BasicConformityEmailBuilder extends ConformityEmailBuilder {
    ...
    /**
     * Gets the url to edit the Conformity termination of the cluster.
     * @param cluster the cluster
     * @return the url to edit the Conformity termination the cluster.
     */
    protected String getConformityClusterUrl(Cluster cluster) {
        return null;
    }
